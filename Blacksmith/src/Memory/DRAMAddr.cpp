...
nlohmann::json DRAMAddr::get_memcfg_json() {
  std::map<size_t, nlohmann::json> memcfg_to_json = {
      {(CHANS(1UL) | DIMMS(1UL) | RANKS(1UL) | BANKS(32UL)),
       nlohmann::json{
           {"channels", 1},
           {"dimms", 1},
           {"ranks", 1},
           {"banks", 32}}},
      {(CHANS(1UL) | DIMMS(1UL) | RANKS(2UL) | BANKS(32UL)),
       nlohmann::json{
           {"channels", 1},
           {"dimms", 1},
           {"ranks", 2},
...
void DRAMAddr::initialize_configs() {
  struct MemConfiguration dram_cfg = {
      .IDENTIFIER = (CHANS(2UL) | DIMMS(2UL) | RANKS(1UL) | BANKS(32UL)),
      .BK_SHIFT = 25,
      ...
      .DRAM_MTX = {          
          0b000000000000000100000010000000,
          0b000000000000011011001100000000,
          0b000000000001001000000000000000,
          0b000000000010010000000000000000,
          0b000000000100100000000000000000,
      ...
      .ADDR_MTX = {          
          ...
          0b000100000000000000000000000010,
          0b001000000000000000000000000001,
          0b100000000010000000000000000000,
          0b011101001100000000000000000011,
          0b000001000000000000000000000000,
          0b000000100000000000000000000000,
          0b000000010000000000000000000000,
          0b000000001000000000000000000000,
  ...
  DRAMAddr::Configs = {
       {(CHANS(2UL) | DIMMS(2UL) | RANKS(1UL) | BANKS(32UL)), dram_cfg}
 };
}
